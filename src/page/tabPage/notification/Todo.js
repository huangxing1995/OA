...
class Todo extends Component{
	...
	renderApproveList(){
		...
		let result = approveList.map((item, i)=>{
			...
			return(
				<TouchableOpacity
					onPress={()=>this.props.navigate('ApproveDetailPage',{approveInfo:item, isInViewMode:false, onRefresh:()=>this.props.onRefresh()})}
...
export default wrapComponent(Todo, [OAStore.userList]);
