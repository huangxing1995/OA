		...
		return(
			<ScrollView style={{flex:1,paddingTop:pxToDp(40),}}>
				...
				<View style={styles.btnWrap}>
					<Text>请假类型</Text>
					<TouchableOpacity onPress={()=>this.handleSelectType()} style={{flexDirection:'row',	justifyContent: 'space-between',alignItems:'center'}}>
						<Text>{this.state.approveInfo.type}</Text>
						<Image
